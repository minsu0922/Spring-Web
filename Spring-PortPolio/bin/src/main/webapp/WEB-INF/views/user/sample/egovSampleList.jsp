...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form modelAttribute="searchVO" id="listForm" name="listForm" method="post">
        ...
        <div id="content_pop">
        	...
        	<div id="title">
        		<ul>
        			<li><img src="<c:url value='/resources/images/common/title_dot.gif'/>" alt=""/><spring:message code="list.sample" /></li>
        		</ul>
        	</div>
        	<!-- // 타이틀 -->
        	<div id="search">
        		<ul>
        			...
        			<li>
        	            <span class="btn_blue_l">
        	                ...
        	                <img src="<c:url value='/resources/images/common/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
        	            </span>
        	        </li>
                </ul>
        	</div>
        	...
        	<div id="paging" class="pagenum1 mt30 center mrtp">
			<ul></ul>
			</div>
        	<!-- /List -->
        	<%-- <div id="paging">
