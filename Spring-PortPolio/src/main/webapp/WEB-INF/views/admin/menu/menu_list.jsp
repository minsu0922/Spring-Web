...
<!-- 메뉴 등록  -->
	...
	<table border="1" >
		...
		<tr>
			...
			<td colspan="2" style="text-align: left;">
				...
				<button type="button" id="btn_select_menu_popup" class="input_btn01 btn03">메뉴 선택</button>
	...
	<div class="clearfix mrtp">
         <button id="btn_submit" class="btn02 input_btn01 right" type="button">등록</button>
    </div>
</form>
	</div>
</div>
